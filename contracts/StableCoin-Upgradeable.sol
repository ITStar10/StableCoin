    ...
    ERC20PausableUpgradeable
{
    ...
    function initialize(
        ...
        //Added in V2
        initializeDomainSeparator(_tokenName);
    }

    /**
     * @dev To be called when upgrading the contract using upgradeAndCall to add delegated transfers
     */
    function initializeDomainSeparator(string memory _tokenName) public {
    ...
    function transferFrom(
        ...
        require(!frozen[recipient] && !frozen[sender] && !frozen[msg.sender], "address frozen");
    ...
    */
    ...
    function _betaDelegatedTransfer(
        ...
        // bytes32 EIP712_DELEGATED_TRANSFER_SCHEMA_HASH = keccak256(
        ...
        bytes32 delegatedTransferHash = keccak256(
            abi.encodePacked(// solium-disable-line
                ...
                to, value, fee, seq, deadline
            ));
        bytes32 hash = keccak256(
            abi.encodePacked(
                "\x19\x01",// EIP191_HEADER, 
                EIP712_DOMAIN_HASH, 
        ...
        require(value.add(fee) <= balanceOf(_from), "insufficent fund");
